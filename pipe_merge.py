...
def push():
    # 模拟数字人生成的视频流和音频流,使用OpenCV读取视频流
    cap = cv2.VideoCapture("output_1710743841513.mp4")
    # 使用librosa读取音频流
    speech_array, _ = librosa.load("aud_1710743841513.wav", sr=44100)  # 对于rtmp, 音频速率是有要求的，测试使用44100没有问题
    speech_array = (speech_array * 32767).astype(np.int16)  # 转为整型

    push_url = 'rtmp://127.0.0.1:1935/live'
